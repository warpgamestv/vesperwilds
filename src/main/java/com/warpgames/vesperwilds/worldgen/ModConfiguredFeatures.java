...
public class ModConfiguredFeatures {
        ...
        public static final ResourceKey<ConfiguredFeature<?, ?>> GLINT_BERRY_PATCH_KEY = registerKey(
                        "glint_berry_patch");
        // Register Keys
        ...
        public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
                ...
                register(context, VELVET_TREE_KEY, Feature.TREE,
                                new TreeConfiguration.TreeConfigurationBuilder(
                                                ...
                                                new CherryFoliagePlacer(
                                                                ...
                                                                0.5f, // Corner hole chance (makes it look
                                                                      // organic/messy)
                ...
                // Register the Patch
                register(context, GLINT_BERRY_PATCH_KEY, Feature.SIMPLE_BLOCK,
                                    new SimpleBlockConfiguration(
                                                    new WeightedStateProvider(
                                                                    WeightedList.<BlockState>builder()
                                                                                    .add(ModBlocks.GLINT_BERRY_BUSH
                                                                                                    .defaultBlockState()
                                                                                                    .setValue(GlintBerryBushBlock.AGE,
                                                                                                                    1),
                                                                                                    1)
                                                                                    .add(ModBlocks.GLINT_BERRY_BUSH
                                                                                                    .defaultBlockState()
                                                                                    ...
                                                                                    .build())));
                // 1. Velvet Fern (Clump)
                register(context, VELVET_FERN_KEY, Feature.SIMPLE_BLOCK,
                                new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.VELVET_FERN)));

                // 2. Vesper Sprouts (Dense carpet)
                register(context, VESPER_SPROUTS_KEY, Feature.SIMPLE_BLOCK,
                                new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.VESPER_SPROUTS)));
        ...
        private static AttachedToLeavesDecorator shelfFungus(Direction dir) {
                return new AttachedToLeavesDecorator(
                                ...
                                1, // x-offset
                                0, // y-offset
                                BlockStateProvider.simple(ModBlocks.EMBER_SHELF_FUNGUS.defaultBlockState()
                                                .setValue(EmberShelfFungusBlock.FACING, dir)),
